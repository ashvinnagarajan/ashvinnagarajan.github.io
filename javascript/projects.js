var projectArray = [
    ...
    projectText: "This summer, I am working remotely as a software engineer at Cisco. I am contributing to the WebEx Teams platform, a product that is used by millions of users every day. My objective is to leverage the AWS cloud and Kubernetes infrastructure to dynamically scale resources based on traffic. I am communicating between teams in San Jose and London to ensure that application specific requirements are met. This feature is expected to result in a 40% cost reduction by minimizing unused resources. In addition, I am also creating an internal debug tool that displays the route of media from endpoints in Python.", 
